...
public class FlatListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int pos = getIntent().getIntExtra("position", 0) + 1;
    ...
    private FlatSTR[] makeFlats() {
        Cursor c;
        c = mDB.query("flats", new String[]{DBHelper.FLATS_COLUMN_FLAT, DBHelper.FLATS_COLUMN_FIREALARM, DBHelper.FLATS_COLUMN_MAGNETFIELD, DBHelper.FLATS_COLUMN_LEAK, DBHelper.FLATS_COLUMN_SECURITY},
                null, null,
                null, null, null);
